...
Amazon Web Services (AWS), Penguin Computing, Softlayer and Microsoft Azure.
In the pubic scope, one of the most popular cloud vendors is AWS that has a wide range of preconfigured instances ready to be launched.
