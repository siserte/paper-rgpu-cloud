...
Because of that, to take the first steps through how to deploy programming computer labs easily, could be really interesting. 

Finally, to bring in more policies to decide the strategy of creating and assigning remote GPUs in the physical device, would be a task to increase the flexibility given by the GPGPU module for Openstack.
