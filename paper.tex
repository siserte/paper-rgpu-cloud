...
\begin{figure}[htb]
  ...
  \caption{Montecarlo execution results}
  \label{fig:mont-opt}
\end{figure}
...
The main idea is to move from the original Openstack architecture (see Figure~\ref{fig:os-orig}) to a solution where a new shared service takes part into the architecture and is responsible for all related to GPU accelerators (see Figure~\ref{fig:external}).
