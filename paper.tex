...
Microsoft Azure allows users to chose a by default system configuration 
or to compose its own system features. On the other hand, institutions/companies 
...
With an small investment in infrastructure and in maintenance can be fulfilled the requests of GPU-capable hosts in a completely transparent way for the user.
...
We have presented an upgrade for Openstack which easily permits to create GPU-instances and manage the physical GPUs to make more profit of them.
