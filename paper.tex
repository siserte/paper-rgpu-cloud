...
of Virtual Machines (VM) which resides inside the host machine and 
...
Depending on the users’ necessities, two approaches to introduce GPGPU computation in the cluster can be determined:
...
Server & Client & BandWidth Gb/s\\ \hline \hline
g2.8xlarge & c3.2xlarge & 1 \\ \hline
g2.8xlarge & c3.8xlarge & 7.5 \\ \hline
g2.8xlarge & g2.2xlarge & 1 \\ \hline
g2.8xlarge & g2.8xlarge & 7.5 \\ \hline
\end{tabular}\end{center}\end{table}
...
\label{subfig:aws3}}
\caption{An AWS instance with several remote GPUs}
\label{fig:aws}
\end{figure*}
