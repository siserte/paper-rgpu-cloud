...
is responsible for all related to GPU accelerators (see Subfigure~\ref{subfig:os-mod}).
...
As soon as the option ``New GPU Pool'' is chosen, the proper fields for the pool configuration appears(see Figure~\ref{fig:ui-launch}).
