...
to share idle GPUs to other machines, several solutions have been presented.
...
So, at this moment the instances used had the features presented in the Table~\ref{table:awsInstances}. 
