...
to share idle GPUs to other machines.
The solution presented by the project gVirtus~\cite{giunta2010gpgpu} virtualizes GPUs and make
...
****** FALTA UNIR AMBAS PARTES DEL TRABAJO ******
...
However, it is not a new topic and in~\cite{tonithesis} is explained that investing in the network infrastructure could make the difference.
